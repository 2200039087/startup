                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/heart.png', // Make sure to add the heart image to your assets
                          width: 100,
                          height: 100,
                        ),
                      ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      _buildDetailCard("Average", "120/80"),
                      _buildDetailCard("Maximum", "130/90"),
                      _buildDetailCard("Minimum", "110/70"),
                    ],
                  ),
                  SizedBox(height: 20),
                  ...
                  Container(
                    ...
                    child: Center(child: Text("Heart Rate Chart")),
                  ),
                  SizedBox(height: 20),
                  Align(
